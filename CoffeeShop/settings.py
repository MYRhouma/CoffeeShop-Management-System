...
DEBUG = True
# LE PREMIER HOST DOIT ETRE LE NOM DE DOMAINE PRINCIPAL !
ALLOWED_HOSTS = ['127.0.0.1',]

SESSION_COOKIE_AGE = 86400
CART_SESSION_ID =   'cart'

# STRIPE_API_KEY_PUBLISHABLE = str(os.getenv('STRIPE_API_KEY_PUBLISHABLE'))
# STRIPE_API_KEY_HIDDEN = str(os.getenv('STRIPE_API_KEY_HIDDEN'))
